      ...
      <Section.Container id="CV" Background={Background}>
        ...
        <Flex justifyContent="center" alignItems="center" flexWrap="wrap">
          <Box width={[1, 1, 4 / 6]} px={[1, 2, 4]}>
            <Fade bottom>
              <div id="cvstil" border="5px solid red;">
                <div id="utdanning">
                  <h2>Utdanning</h2>
                  <p id="bachelor">
                    <h4>
                    ...
                    universitetet tilbyr, i tillegg til en spesialisering
                    innenfor datasikkerhet.
                  </p>
                  <p id="forsvaret">
                    <h4>
                      Luftforsvaret, Ørland flystasjon — 07.2016 - 07.2017
                    </h4>
                    Arbeidet med å overvåke flystasjonen fra et kommandosenter.
                    I tillegg til dette var jeg hovedtillitsvalgt for
                    basetroppen på Ørland, og fungerte som bindeleddet mellom
                    soldater og befal.
                  </p>
                </div>
                <br />
                <div id="erfaring">
                  ...
                  <p id="klasseleder">
                    ...
                    Klasseleder for førsteårsstudentene på datasikkerhet. Var
                    med å veilede, samt gi studentene en god og relevant start
                    på studietilværelsen. Var gjennom et kurs i organisasjon og
                    ledelse i forkant av dette.
                  </p>
                  <p id="åpen dag">
                    <h4>
                      <i>Åpen dag</i>-medhjelper, Universitetet i Bergen —
                      02.2018 - 03.2018
                    </h4>
                  ...
                  <p id="natvigs minde">
                    <h4>
                      Arrangementsmedarbeider, Natvigs Minde, Stavanger —
                      04.2013 - 07.2020
                    </h4>
