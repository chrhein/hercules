    ...
    <div className="nine columns main-col">
      <div className="row item">
        <div className="twelve columns">
          ...
          <p className="resumeParagraph">
            echo karriere is the student organization behind the career day for
      ...
      <div className="row item">
        <div className="twelve columns">
          ...
          <p className="resumeParagraph">
            The Institute Council has the opportunity to influence the subjects
      ...
      <div className="row item">
        <div className="twelve columns">
          ...
          <p className="resumeParagraph">
            Bedkom is a sub-group of the student association echo and offers
      ...
      <div className="row item">
        <div className="twelve columns">
          ...
          <p className="resumeParagraph">
            echo Tilde is a sub-group of the student association echo and is
      ...
      <div className="row item">
        <div className="twelve columns">
          ...
          <p className="resumeParagraph">
            I was the elected representative for my troop and served as a link
