      ...
      <div className="nine columns main-col">
        ...
        <div className="row item">
          <div className="twelve columns">
            ...
            <p className="resumeParagraph">
              echo Tilde is a sub-group of the student association echo and is responsible for events for the students
              at the
              Institute of Informatics. My job is to plan and conduct events and achieve our goal to strengthen the
              social
