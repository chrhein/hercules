      ...
      <div className="nine columns main-col">
        <div className="row item">
          <div className="twelve columns">
            <h3 className="resumeHeader">
              Master&apos;s Degree in Informatics specializing in Visualization
            </h3>
            <p className="info">
            ...
            <p className="resumeParagraph">
              A Master&apos;s Degree that results in great knowledge and
              advanced skills in visualization, computer graphics, and
              interactive techniques, as well as good skills in related
              programming.
            </p>
          </div>
        </div>
        ...
        <div className="row item">
          <div className="twelve columns">
            ...
            <p className="resumeParagraph">
              Worked as an operator in an alarm central at Ørland Air Station,
              in shifts of 12 hours a day, 14 days in a row.
            </p>
          </div>
        </div>
      </div>
