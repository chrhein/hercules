    ...
    <div className="nine columns main-col">
      <div className="row item">
        <div className="twelve columns">
          <h3>Master&apos;s Degree in Informatics specializing in Visualization</h3>
          <p className="info">
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>Bachelor&apos;s Degree in Computer Security</h3>
          <p className="info">
            University of Bergen
            <span className="bullet">&bull;</span>
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>Initial Compulsory Military Service</h3>
          <p className="info">
